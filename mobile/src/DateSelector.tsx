...
export function DateSelector({ value, onChange }: { value: string; onChange: (value: string) => void }) {
  return <View><Text style={styles.label}>Data în format AAAA-LL-ZZ</Text><TextInput accessibilityLabel="Data lucrării" value={value} onChangeText={onChange} placeholder="2026-09-01" inputMode="numeric" style={styles.input}/></View>;
}
