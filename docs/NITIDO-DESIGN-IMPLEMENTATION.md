...
| 06 Detaliu lucrare | 10 | `/client`, `JobMessages` | Fluxul existent păstrat; alinierea completă la planșă rămâne de făcut |
...
| 09 Execuție mobilă | 8 | `/firma/executie`, aplicația firmei | Verificările existente păstrate; alinierea completă la planșă rămâne de făcut |
