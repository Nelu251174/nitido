...
The deployed production SHA has NOT been confirmed. Coolify returned 502 to the browser. Do not merge blindly into main: main has older design and an incompatible Pro prototype.
