...
afterEach(()=>db.close());
it('uses the Romanian completion day, stored amounts, client and recorded duration',()=>{expect(earningsForMonth(db,'f','2026-09')).toMatchObject([{day:'2026-09-01',clientName:'Client Test',recordedMinutes:60,estimatedMinutes:150,gross:550,commission:113,net:437,confirmedNet:437}]);expect(earningsForMonth(db,'f','2026-08')).toEqual([]);});
