...
export function WorkspaceNav({role='client',onNavigate}:{role?:'client'|'firma'|'admin';onNavigate?:(href:string)=>void}){
 ...
 ['Acasă','/client','home'],['Rezervări','/client#sec-lucrari','calendar'],['Proprietăți','/client/proprietati','building'],['Mesaje','/client/mesaje','chat'],['Plăți','/client#sec-plata','card'],['Cont','/client#sec-cont','user'],['Evaluări','/client/evaluari','briefcase'],['Business','/client/business','chart'],['Curățenie între rezervări','/client/host','home'],['Aprobări și acces','/colaborari','shield'],['Lucrările echipei','/echipa','users']
 ]:role==='firma'?[
