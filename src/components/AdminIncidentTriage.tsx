...
export function AdminIncidentTriage({caseId,caseRevision,onSaved}:{caseId?:string;caseRevision?:string;onSaved:()=>Promise<void>}){
 ...
 return <div className="rounded-xl border p-4 space-y-3" style={{background:'#fbf7ef',borderColor:'#ddd4c5'}}>
  ...
  {loading?<p>Se încarcă termenele…</p>:<>
   <details><summary>Configurează termenele pentru cazurile viitoare</summary>
