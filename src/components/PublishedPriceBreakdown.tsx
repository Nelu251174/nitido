...
const labels:Record<string,string>={cleaning:'Serviciu de curățenie',windows:'Spălare geamuri (separat)',express60:'Supliment Express 60',platform_credit:'Credit aplicat'};
