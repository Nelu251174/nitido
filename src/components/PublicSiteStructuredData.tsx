...
export function PublicSiteStructuredData(){
 const data={"@context":"https://schema.org","@graph":[
  {"@type":"Organization","@id":"https://nitido.ro/#organization",name:"NITIDO.RO",url:"https://nitido.ro/",logo:"https://nitido.ro/icons/icon-512x512.png",email:"contact@nitido.ro",telephone:"+40341402403"},
