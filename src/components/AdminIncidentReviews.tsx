...
import {AdminIncidentResolution} from './AdminIncidentResolution';
...
export function AdminIncidentReviews({canManage=true,canReview=true,canFinance=true}:{canManage?:boolean;canReview?:boolean;canFinance?:boolean}){
 ...
 return <section id="incidente" className="design-panel my-5 space-y-4">
  ...
  {canReview&&<AdminIncidentTriage canManage={canManage} caseId={current?.id} caseRevision={current?.updated_at} onSaved={load}/>}
