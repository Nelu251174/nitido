...
export function LivePriceEstimator({options,inline=false}:{options?:EstimatorOption[];inline?:boolean}={}){
  ...
  return <div className={`${inline?"relative w-full":"absolute bottom-[-20px] right-[-18px] w-[330px] max-sm:right-3 max-sm:w-[calc(100%-24px)]"} rounded-2xl bg-[#111827] p-5 text-white shadow-2xl`}>
