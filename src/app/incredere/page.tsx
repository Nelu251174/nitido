...
const sections = [
  ...
  [
    ...
    "Asistentul AI poate explica pașii și informațiile permise din cont, dar nu hotărăște plăți sau reclamații. Pentru intervenție umană, contactează support@nitido.ro. Include identificatorul lucrării, ce s-a întâmplat, când ai observat problema și ce clarificare soliciți. Păstrează mesajele relevante și ascunde datele inutile din capturi. O cerere de suport nu reprezintă, în sine, confirmarea unei anulări sau rambursări."
  ]
] as const;
