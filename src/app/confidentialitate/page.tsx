...
export default function Page(){const legal=legalIdentityStatus();const sections:InfoSection[]=[
  ...
  {title:"Localizare la rezervare",paragraphs:["Cu permisiunea telefonului sau browserului, citim locația o singură dată când configurezi o rezervare. Coordonatele sunt trimise direct din dispozitiv către BigDataCloud pentru identificarea localității; furnizorul primește și adresa IP a conexiunii. Nu trimitem numele sau datele contului în această solicitare.","NITIDO nu păstrează coordonatele obținute pentru completarea localității și nu urmărește deplasarea clientului în fundal. Poți refuza localizarea și completa adresa manual. Numai adresa confirmată la publicare se salvează cu rezervarea. Politica furnizorului: https://www.bigdatacloud.com/privacy-and-cookie-policy."]},
