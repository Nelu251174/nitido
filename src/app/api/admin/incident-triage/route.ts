...
import {getAdminActorId,isAdmin,auditAdminAction} from '@/lib/adminAuth';
...
export async function POST(req:NextRequest){
 ...
 if(b.action==='policy'&&!await isAdmin('manage'))return response({error:'Managerul operațional configurează termenele.'},403);
