...
export default function Page(){return <InformationPage eyebrow="TRUST & SAFETY" title="Siguranță construită prin limite clare și autoritate pe server." intro="NITIDO.RO separă rolurile, minimizează datele expuse și păstrează operațiunile sensibile în fluxurile autorizate. Nu pretindem certificări de securitate care nu sunt documentate." sections={[
  ...
  {title:"Protecția adresei exacte",paragraphs:["Înainte de alocare, firmele văd numai informații neconfidențiale. Adresa exactă este disponibilă exclusiv firmei câștigătoare după alocarea confirmată de server (acceptarea firmei la Express sau alegerea clientului la Standard)."]},
  {title:"Alocare autoritară",paragraphs:["Alocarea schimbă atomic starea lucrării — fie prin acceptarea firmei (Express), fie prin alegerea clientului dintre oferte (Standard). Telefonul sau interfața nu pot atribui singure o lucrare și două firme nu o pot câștiga simultan."]},
